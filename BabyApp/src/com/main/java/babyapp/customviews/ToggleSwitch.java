...
public class ToggleSwitch extends LinearLayout{
    ...
    public ToggleSwitch(final Context context, AttributeSet attrs) {
        ...
        if(attrs != null){
            ...
            mActiveBgColor                      = a.getColor(R.styleable.ToggleSwitchOptions_activeBgColor, ContextCompat.getColor(context, R.color.colorPrimary)); // R.color.blue
            ...
            mInactiveBgColor                    = a.getColor(R.styleable.ToggleSwitchOptions_inactiveBgColor, ContextCompat.getColor(context, R.color.grey_300)); //R.color.gray_light
            ...
            mToggleWidth                        = a.getDimension(R.styleable.ToggleSwitchOptions_toggleWidth, dp2px(getContext(), 50));
