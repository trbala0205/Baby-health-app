...
public class ScreeningSummaryMenuAdapter extends BaseAdapter {
 
    private Activity activity;
    private ArrayList<String> menuList, hintList;
    private LayoutInflater inflater=null;
 
    public ScreeningSummaryMenuAdapter(Activity _activity, ArrayList<String> _arrayList, ArrayList<String> _hintList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
            view = inflater.inflate(R.layout.screening_summary_list_row_item, null);
