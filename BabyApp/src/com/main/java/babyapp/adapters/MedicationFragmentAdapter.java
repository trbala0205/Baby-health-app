...
public class MedicationFragmentAdapter extends BaseAdapter {
 
    private Activity activity;
    private ArrayList<String> menuList, hintList;
    private LayoutInflater inflater=null;
 
    public MedicationFragmentAdapter(Activity _activity, ArrayList<String> _arrayList, ArrayList<String> _hintList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
            view = inflater.inflate(R.layout.medication_fragment_list_item_row, null);
